...
public class IpV4Network implements IpNetwork {
     ...
     *
     * @param ip      string form of IPv4 addresses eg: 192.168.0.1
     * @param netmask string form of IPv4 network mask eg: 255.255.255.0
     */
     ...
     *
     * @param ip       string form of IPv4 addresses eg: 192.168.0.1
     * @param cidrMask integer netmask [0;32]
     */
     ...
     *
     * @param cidrIp full address with mask aa.bb.cc.dd/nn
     */
     ...
     *
     * @param stringIp String representation of IP Address
     ...
     *
     * @param mask integer value of mask
